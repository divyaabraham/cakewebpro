...
<html>
  ...
  <body background="images/rest1.jpg">
    ...
    <style>
        ...
        h1,p,a,h2,h3{font-family: 'Marck Script', cursive;}
    </style>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="index.php"><span class="glyphicon glyphicon-cutlery"></span>  Your Cakes </a></li>
...
<h2 class="text-center"> Thank you for Ordering at Bakers Studio! The ordering process is now complete.</h2>
