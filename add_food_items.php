...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
            ...
            <a href="add_food_items.php" class="list-group-item active">Add Cake</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right" style="font-family: 'Marck Script', cursive"> ADD CAKE </button>
      </div>
        </form>
