<html>
  ...
  <head>
    <title> Manager Signup | Bakers Studio </title>
  </head>
   ...
   <p>Get started by creating your account</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading" style="font-family: 'Marck Script', cursive"> Create Account </div>
        ...
        <div class="row">
          <div class="form-group col-xs-4">
              <button class="btn btn-primary" type="submit" style="font-family: 'Marck Script', cursive">Submit</button>
          </div>
